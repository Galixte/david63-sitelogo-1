...
$lang = array_merge($lang, array(
	...
	'SITE_LOGO_EXPLAIN'					=> 'Here you can set the options for a custom site logo to replace the default logo, add a custom banner, use an extended board description, modify the header bar or add a background to your board.<br /><br />Be aware that not necessarily all permutations of the options below will work together, or that the use of some of the options in combination with other options may produce undesired results.',
